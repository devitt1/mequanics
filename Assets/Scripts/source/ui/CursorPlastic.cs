...
public class CursorPlastic
{
	 ...
	 * to the mouse move.
	 */
	public KeyValuePair<Vector3, Vector3> GetArrow(Axis o)
	{
	...
	{		
		m_visual = PrefabHubCS.Instance.GetPrefabCursorPlastic();
		...
		SetAxes(Axis.INVALID, Axis.INVALID);
	}
